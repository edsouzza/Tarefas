...
{  
    ...
    public String mostrarTituloDoFormulario()
    {
        ...
        if(qdeRegsATIVOS == 1){
           return "Gerenciamento de " + nomeTabela +" com "+qdeRegs+" registro(s) cadastrado(s) e "+qdeRegsATIVOS+" ativo"; 
        }else{
           return "Gerenciamento de " + nomeTabela +" com "+qdeRegs+" registros cadastrados e "+qdeRegsATIVOS+" ativos";  
        }

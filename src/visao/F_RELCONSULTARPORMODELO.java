...
public class F_RELCONSULTARPORMODELO extends javax.swing.JFrame {
    ...
    public F_RELCONSULTARPORMODELO() {
        initComponents();
        Leitura();        
        setResizable(false);              //desabilitando o redimencionamento da tela        
        setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE); //desabilitando o botao fechar
        this.setTitle("Listar Patrimônios Ativos Por Modelo Selecionado");        
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        try {            
               objRel.imprimirPatrimoniosDoModeloSelecionado("relatorio/relPatrimoniosModeloSelecionado.jasper", codigoTipoModelo);           
        } catch (Exception e) {
            e.printStackTrace(); 
    ...
    private void btnListarModelosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarModelosActionPerformed
        ...
        String sTitle = "Encontrados "+totalRegs+" patrimônios ativos do modelo "+TipoModelo;

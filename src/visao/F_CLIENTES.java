...
public class F_CLIENTES extends javax.swing.JFrame {
    ...
    int codigo, idSecaoRegSel, ind, deptoid = 0;
    String secao, rf, nome, sNomeSecao, obs, tipo, departamento, setartipo,tiposetado = "";
    ...
    private void initComponents() {
        ...
        cmbSecao = new javax.swing.JComboBox<String>();
        ...
        setSize(new java.awt.Dimension(767, 667));
    ...
    private void txtRFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtRFFocusGained
        ...
        if (cadastrando){
            ...
            if(umMetodo.temCadastradoNaTabela("TBLCLIENTES","nome",nomeDigitado)){
               JOptionPane.showMessageDialog(null, "Atenção o cliente "+nomeDigitado+" já esta cadastrado, verifique!","DUPLICIDADE DE CADASTRO",2);               
                btnVoltarActionPerformed(null);
            }else{     
                //DESCOBRINDO QTOS CARACTERES TEM ANTES DO ESPAÇO NA STRING DIGITADA
    ...
    private void editarRegistro() 
    {
        ...
        if(cmbStatus.getSelectedItem().toString().equals("INATIVO")){
            ...
            String nomeDaSecaoCliente    = cmbSecao.getSelectedItem().toString();
            
            //USUARIO A SER INATIVADO
            String nomeSemUsuarioDaSecao = "SEM USUARIO "+nomeDaSecaoCliente;   
            int idSemUsuarioDaSecao      = umMetodo.getCodigoPassandoString("tblclientes", "nome", nomeSemUsuarioDaSecao); //293 SEM USUARIO DOG

...
public class F_GERARNOMESTACOES extends javax.swing.JDialog  {
    ...
    public F_GERARNOMESTACOES() 
    {
        ...
        umaBiblio.configurarBotoes(btnExcluirNome);           
    ...
    private void initComponents() {
        ...
        btnExcluirNome.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnExcluirNome.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/btn_sairPrograma.gif"))); // NOI18N
        btnExcluirNome.setText("Excluir");
        btnExcluirNome.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnExcluirNome.setEnabled(false);
        panelPrincipal.add(btnExcluirNome);
        btnExcluirNome.setBounds(410, 80, 110, 40);
        ...
        btnGerarNomes.setBounds(290, 80, 110, 40);
        ...
        btnSair.setBounds(810, 80, 100, 40);
        ...
        btnLimpar.setToolTipText("Filtrar por Departamento");
        ...
        btnLimpar.setBounds(700, 80, 100, 40);
        ...
        btnTodosDisponiveisDepto.setToolTipText("Filtrar por Departamento");
        ...
        btnTodosDisponiveisDepto.setBounds(530, 80, 160, 40);
    ...
    private void btnTodosDisponiveisDeptoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTodosDisponiveisDeptoActionPerformed
        if(cmbDeptos.getSelectedIndex() < 0){
            JOptionPane.showMessageDialog(null, "Escolha um Departamento para pesquisar!", "Departamento inválido!", 2);
        }else{
             if(nomeDepartamento.equals("BIBLIOTECA")){
                nomeDepartamento = "CEJUR";
             }
    ...
    public javax.swing.JButton btnExcluirNome;

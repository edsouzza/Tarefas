...
public class F_RELMEMOSTRANSFERIDOSPORTIPO extends javax.swing.JFrame {
    ...
    public F_RELMEMOSTRANSFERIDOSPORTIPO() {
        ...
        this.setTitle("Lista Memorandos de Patrimônios Transferidos Por Modelo de Equipamento");        
    ...
    public void PreencherTabela(String sql)
    {
        ...
        try {
            ...
            jTabela.getColumnModel().getColumn(2).setPreferredWidth(725); //define o tamanho da coluna

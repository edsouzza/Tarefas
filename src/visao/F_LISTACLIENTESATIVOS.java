...
public class F_LISTACLIENTESATIVOS extends javax.swing.JDialog {
    ...
    String sqlTodos   = ("Select c.codigo, c.nome, c.rf, c.deptoid, s.nome as secao, c.tipo from tblclientes c, tblsecoes s, tbldepartamentos d where c.tipo<>'N' and c.secaoid=s.codigo and c.deptoid=d.codigo and c.status='ATIVO' order by c.nome");     

    public F_LISTACLIENTESATIVOS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    {                
        ...
        this.setTitle("Total de usuários físicos ativos : "+totalRegs);     
    }
    ...
    {
         String sqlFiltro    = ("Select c.codigo, c.nome, c.rf, c.deptoid, s.nome as secao, c.tipo from tblclientes c, tblsecoes s, tbldepartamentos d where c.tipo<>'N' and c.secaoid=s.codigo and c.deptoid=d.codigo and c.status='ATIVO' and c.nome like '%" + pPesq + "%' order by c.nome");           
         //String sqlVirtuais  = ("Select c.codigo, c.nome, c.rf, c.deptoid, s.nome as secao, c.tipo from tblclientes c, tblsecoes s, tbldepartamentos d where c.secaoid=s.codigo and c.deptoid=d.codigo and  c.tipovirtualid="+codTipoVirtual+"  and c.status='ATIVO' and c.nome like '%" + pPesq + "%' order by c.nome");    
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                F_LISTACLIENTESATIVOS dialog = new F_LISTACLIENTESATIVOS(new javax.swing.JFrame(), true);

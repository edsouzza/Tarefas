...
public class F_PATRIMONIOS extends javax.swing.JFrame {
    ...
    int cont,ipesqPorCod,ipesqPorIP,codEstacaoParaEditar,codigo, idClienteRegSel, ind, idSecao, numeroColuna, idModelo,deptoid, tipoid, controleMostraDescricao, idCodigoIPDisponivel, idCodigoEstacaoDisponivel, codPatrimonio = 0;
    boolean entrouNovaObs, selecionouTipo,escolheuModelo,reativando,gravando,transferindo,semIP, alterouIP, alterouEstacao, editando, cadastrando, flagImprimiu, listouClientesParaEdicao, alterouStatus, bEncontrou, clicouNaTabela, filtrou, naoMicro, clicouInativos, filtrouClicou, selecionouItem,estacaoRecebeuDisponivel;  //controla no botão gravar entre gravar novo registro e gravar alteração de um registro    
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(971, 883));
...
private void disponibilizarNomeEstacao(int pCod)
{
...
private void gravarEdicaoRegistro() 
{
    ...
    if (alterouStatus) //Ao clicar no botão de status foi identificado que foi alterado o mesmo
    {
        ...
        disponibilizarNomeEstacao(codEstacao);
...
//    }
//    
//    if(tipo.equals("SWITCH")){
//        if(!umPatrimonioDAO.duplicidadeSwitchDAO(codigo, serie)){
//            umControlePatrimonio.atualizarPatrimonio(umModPatrimonio);        
//            umGravarLog.gravarLog("atualizacao no cadastro de um(a) "+txtTIPO.getText()+" serie "+umModPatrimonio.getSerie());
//        }
//    }
...
//        if(!umPatrimonioDAO.duplicidadeMonitorDAO(codigo, serie)){
//            umControlePatrimonio.atualizarPatrimonio(umModPatrimonio);        
//            umGravarLog.gravarLog("atualizacao no cadastro de um(a) "+txtTIPO.getText()+" serie "+umModPatrimonio.getSerie());
//        }
//    }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
      if(umaBiblio.permissaoLiberada()){
        ...
        //ACRESCENTANDO A OPCAO DE INATIVAÇÃO NA COMBO CMBSTATUS PARA EDIÇÃO DO STATUS
//        if(!nomeESTACAOOLD.equals("PGMCGGMC000")){
//             cmbSTATUS.addItem("INATIVO");
//        }
...
//                isImpressora=true;
//            }else if(tipo.equals("SWITCH")){      //SWITCH = 3
//                isSwitch=true;
//            }else if(tipo.equals("SCANNER")){  
//                isScanner=true;
//            }else if(tipo.equals("NOTEBOOK")){  
...
//        if(txtTIPO.getText().equals("SWITCH")){
//            isSwitch = true;
//            //JOptionPane.showMessageDialog(null, "TIPO: "+txtTIPO.getText());
//        }else if(txtTIPO.getText().equals("SCANNER")){
//            isScanner = true;
//            //JOptionPane.showMessageDialog(null, "TIPO: "+txtTIPO.getText());
//        }else if(txtTIPO.getText().equals("MONITOR")){
//            isMonitor = true;
//            //JOptionPane.showMessageDialog(null, "TIPO: "+txtTIPO.getText());
...
//            isMicro=true;
//            //JOptionPane.showMessageDialog(null, "TIPO: "+txtTIPO.getText());
//        }else if(txtTIPO.getText().equals("GBIT")){
//            isGbit=true;
//            //JOptionPane.showMessageDialog(null, "TIPO: "+txtTIPO.getText());
//        }
